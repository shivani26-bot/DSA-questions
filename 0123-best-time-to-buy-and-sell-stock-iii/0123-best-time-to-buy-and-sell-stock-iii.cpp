class Solution {
public:
// for transactions to be completed it must be a buy and sell
// set a cap of 2 initially, only if you sell then decrease the cap by 1/
